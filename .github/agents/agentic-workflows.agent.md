...
> [!IMPORTANT]
> For architecture/pattern-selection requests, load `https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/patterns.md` first.
...
- Configuration: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/github-agentic-workflows.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/create-agentic-workflow.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/update-agentic-workflow.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/debug-agentic-workflow.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/upgrade-agentic-workflows.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/report.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/create-shared-agentic-workflow.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/dependabot.md
...
**Prompt file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/test-coverage.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/asciicharts.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/cli-commands.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/token-optimization.md
...
**Reference file**: https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/patterns.md
...
- Always reference the instructions file at https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/github-agentic-workflows.md for complete documentation
- Use the MCP tool `agentic-workflows` when running in GitHub Copilot Cloud
- Workflows must be compiled to `.lock.yml` files before running in GitHub Actions
- **Bash tools are enabled by default** - Don't restrict bash commands unnecessarily since workflows are sandboxed by the AWF
- Follow security best practices: minimal permissions, explicit network access, no template injection
- **Network configuration**: Use ecosystem identifiers (`node`, `python`, `go`, etc.) or explicit FQDNs in `network.allowed`. Bare shorthands like `npm` or `pypi` are **not** valid. See https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/network.md for the full list of valid ecosystem identifiers and domain patterns.
- **Single-file output**: When creating a workflow, produce exactly **one** workflow `.md` file. Do not create separate documentation files (architecture docs, runbooks, usage guides, etc.). If documentation is needed, add a brief `## Usage` section inside the workflow file itself.
- **Triggering runs**: Always use `gh aw run <workflow-name>` to trigger a workflow on demand — not `gh workflow run <file>.lock.yml`. `gh aw run` handles workflow resolution by short name, input parsing and validation, and correct run-tracking for agentic workflows. Use `--ref <branch>` to run on a specific branch.
- **CLI commands reference**: For a complete guide on all `gh aw` commands and their MCP tool equivalents (for restricted environments), see https://github.com/github/gh-aw/blob/v0.75.0/.github/aw/cli-commands.md
